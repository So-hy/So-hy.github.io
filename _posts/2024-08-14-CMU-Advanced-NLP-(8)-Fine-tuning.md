...
그리고 실제로 이를 사용할 때, 어떤 어댑터를 사용할지를 결정하고 그 어댑터의 값을 취하게 됩니다. 이 아이디어가 좋은 이유는 특정 작업에 유용한 모듈을 학습하고 필요할 때 이를 선택할 수 있기 때문이다. 이를 통해 창의적인 작업들을 할 수 있을 것이라 생각된다고 . 또한 다국어 버전도 있는데, 개별 언어에 대해 어댑터를 학습하고 개별 작업에 대해 어댑터를 학습한 후 이를 결합할 수도 있습니다. 이게 흥미롭다면 한번 살펴보세요.
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc3NzA0ODY4NSwtMTg5MjAwNzkyOCwxNj
...
NzYyLC0xNjg5MTYxMzczLDM1NDk1MDczOCwtMTgxMjQ2OTU1OS
wxMjI1OTI1Njk2LDQxMDg4NTUwOCwtMTc0MjE5ODExNSwtMzIz
MjIzNDQwXX0=
-->