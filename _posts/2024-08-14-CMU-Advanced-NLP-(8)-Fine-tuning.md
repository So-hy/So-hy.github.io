...
위 그림에서는 LoRA는 Pre-Trained 와는 별도의 계산 경로로 표현되어 있다. 하지만, 실제로는 이 두 행렬을 더해서 Pre-trained Weight로 사용해도 동일한 결과를 얻을 수 있다. 이 행렬을 원래 가중치에 추가하면 별도로 계산하고 나중에 더한 것과 동일한 결과를 얻습니다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExNzI3MjY4MTAsNDU1NzI4MjM1LDY2Nj
