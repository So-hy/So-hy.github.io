...
Q-LoRa는 quantization 과 파라미터 효율 조정(Parameter Efficient Tuning)을 결합한 것이다. 기본적으로 모델을 16비트가 아닌 4비트로 압축할 수 있는 방법이 있으며, 이렇게 하면 모델이 매우 작아진다.
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjA3MTY1MDg5MywxMTk4NTYxOTEsODM5MT
