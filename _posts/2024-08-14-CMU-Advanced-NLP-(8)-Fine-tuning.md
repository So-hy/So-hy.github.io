...
또 다른 방법으로는 수학 문제의 숫자를 약간 변경하는 것처럼 입력을 약간 변형하여 전체 정확도에 영향을 미치는지 확인하는 방법이 있다. 이런 방식으로 약간의 변형을 가한 후, 성능에 큰 차이가 있으면 문제가 있다고 판단할 수 있다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTcxOTg0NDYwMSwxNzc1NTMwOTI2LC0xMj
