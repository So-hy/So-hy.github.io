...
트랜스포머 모델은 순수하게 Attention에 집중을 한다. 그러다보니 동일한 단어(또는 subword)가 문장 내에 다른 위치에 있을 때, 이를 구별할 수가 없다. 즉, 위치에 대한 정보가 없다는 것.  
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4NzY0NzIxMzUsMTAzNzQyOTQwOCwtMT
