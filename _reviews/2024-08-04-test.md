...
각 토큰에 대해서
$$
L(Q, D^+, D^−) = \sum_{i \in D^+} \sum_{j \in D^-} \log\left(1 + \exp\left(\text{sim}(H_Q, H_{D_j}^-) - \text{sim}(H_Q, H_{D_i}^+)\right)\right)
$$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU0Nzk0NzI3LDYyMjMzNjM5MCwtMTQ1Mj
g1NjQ4OCw1MTI2OTEwMzQsMTg4MzU1NjY3NSwtMTM4MzgwODk0
NSw1ODE1NDI5LDUwNDgyNjQwMiwtODk0MDA2OTgsLTg5MjU2Nj
I1NSwtMTIzNDkzNjY4MywtNzc5NjU1MDgsODA4MzYyMzEwLDcw
MDA5MTMyMSwtMTgyMzI1MDQsLTE0MTkyODQ2ODYsLTE5NTA4Nj
E5NDEsMTM1ODkyNzM3NiwtOTQ4ODgyNzgyLDQ5MzM1Mjg1OF19
