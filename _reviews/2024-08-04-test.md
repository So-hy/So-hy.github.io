...
이렇게 만들어진 집합 $D'$와 질문 $Q$를 BERT 를 사용하여 인코딩한다, 이를 통해 $H^Q$ 와 $H^D$ 라는 표현을 생성한다. 인코딩을 할 때, BERT의 기능을 향상 시키기 위해, 질문과 문장 파트에 각각 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTYyMzA0ODcwMywtODk0MDA2OTgsLTg5Mj
