...
이렇게 만들어진 집합 $D'$와 질문 $Q$를 BERT 를 사용하여 인코딩한다, 이를 통해 $H^Q$ 와 $H^D$ 라는 표현을 생성한다. 인코딩을 할 때, BERT의 기능을 향상 시키기 위해, 질문과 문장 파트에 각각 특별한 토큰 $[Q]$와 $[D]$를 추가했다. (이로 인해, 모델은 학습을 하면서 질문과 문장 집합을 명확하게 구분하게 된다고 한다.) 또한 질문 토큰을 $[mask]$ 토큰으로 패딩하여 BERT가 질문의 의미를 최적화하도록 하였다. 그리고 질문과 문장 $Q, D$를 하나의 시퀀스로 연결하여 상호작용을 강화하였다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTA0ODI2NDAyLC04OTQwMDY5OCwtODkyNT
Y2MjU1LC0xMjM0OTM2NjgzLC03Nzk2NTUwOCw4MDgzNjIzMTAs
NzAwMDkxMzIxLC0xODIzMjUwNCwtMTQxOTI4NDY4NiwtMTk1MD
g2MTk0MSwxMzU4OTI3Mzc2LC05NDg4ODI3ODIsNDkzMzUyODU4
LC0xMjAyNjI2OTkzLC0xNzY3OTc5NjA5LDIxMzAzOTY3NzYsLT
E5OTM2NDIzODgsLTE4NDAwNjMzMjAsLTE2OTIwMzMyNzMsLTE4
ODEwMjk0MDFdfQ==
-->