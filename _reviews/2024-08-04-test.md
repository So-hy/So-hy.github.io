...
위의 식과 같이 표현할 수 있으며, 첫 번째 단계에서의 LSTM의 입력인 $y_0$ 는 훈련 시 무작위로 초기화된다. 이후 단계에서는 이전 단계에서 생성된 토큰  $y_{t-1}$ 을 입력으로 받는다. 디코더의 목표는 질문, 문장 또는 DSL에서 선택할 토큰을 결정하는 것이다.  위 식, 그리고 후술할 내용에서 $t$  단계에서의 변수들은 명시적으로 적지 않고  $t$ 로 간주한다.

이전에 생성된 토큰 시퀀스  $Y_t = [y_1; y_2; \cdots; y_{t-1}]$ 와 DSL 및 질문의 표현  $H_{DSL} \| H$ 에 대해 어텐션을 계산하여 디코더 이력 표현과 시퀀스 표현을 얻습니다:
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTMyMDM4ODU3MiwtMTk2MDc2MDQzMywtND
gwMjU1MDU1LDk3ODY1ODksMTgzNDQ1MjMwNCw1NzI4NTg4NzQs
NjIyMzM2MzkwLC0xNDUyODU2NDg4LDUxMjY5MTAzNCwxODgzNT
U2Njc1LC0xMzgzODA4OTQ1LDU4MTU0MjksNTA0ODI2NDAyLC04
OTQwMDY5OCwtODkyNTY2MjU1LC0xMjM0OTM2NjgzLC03Nzk2NT
UwOCw4MDgzNjIzMTAsNzAwMDkxMzIxLC0xODIzMjUwNF19
-->