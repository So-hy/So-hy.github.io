...
이렇게 만들어진 집합 $D'$와 질문 $Q$를 BERT 를 사용하여 인코딩한다, 이를 통해 $H^Q$ 와 $H^D$ 라는 표현을 생성한다. 인코딩을 할 때, BERT의 기능을 향상 시키기 위해, 질문과 문장 파트에 각각 특별한 토큰 $[Q]$와 $[D]$를 추가했다. 또한 질문 토큰을 $[mask]$ 토큰으로 패딩하여 BERT가 질문의 의미를 최적화하도록 하였다. 그리고 질문과 문장 $Q, D$를 하나의 시퀀스로 연결하여 상호작용을 강화하였다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTYyODMwODIzOCwtODk0MDA2OTgsLTg5Mj
U2NjI1NSwtMTIzNDkzNjY4MywtNzc5NjU1MDgsODA4MzYyMzEw
LDcwMDA5MTMyMSwtMTgyMzI1MDQsLTE0MTkyODQ2ODYsLTE5NT
A4NjE5NDEsMTM1ODkyNzM3NiwtOTQ4ODgyNzgyLDQ5MzM1Mjg1
OCwtMTIwMjYyNjk5MywtMTc2Nzk3OTYwOSwyMTMwMzk2Nzc2LC
0xOTkzNjQyMzg4LC0xODQwMDYzMzIwLC0xNjkyMDMzMjczLC0x
ODgxMDI5NDAxXX0=
-->