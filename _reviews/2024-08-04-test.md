...
이런 형태로 변환하는데, 위의 표를 토대로 작성하면 “2016년 제3자 판매는 $1802; 2015년 제3자 판매는 $1882; …“와 같이 변환된다. 이렇게 변환된 문장과 검색된 문장을 합쳐 $D'$ 집합을 만든다. $D′ = {D1,D2,··· ,Dn}∪{D_\text(n+1)),Dn+2,··· ,Dn+r}$ 여기서 합집합 앞의 Dn의 경우 검색된 문장을 의미하고, 뒤의 Dn+1 부분은 테이블을 문장형태로 변환한 것을 의미한다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTk5ODgwNjk5NCwtMTIzNDkzNjY4MywtNz
