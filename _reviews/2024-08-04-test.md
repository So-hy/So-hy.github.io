...
이 논문에서는 위의 문제를 해결하기 위해 **DyRRen**이라는 새로운 프레임워크를 제안합니다. DyRRen은 생성의 각 단계에서 문장에 대한 주의를 동적으로 조정하는 **동적 재순위 메커니즘**을 사용합니다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTkzNTA1MjY0MiwtMTc2Nzk3OTYwOSwyMT
