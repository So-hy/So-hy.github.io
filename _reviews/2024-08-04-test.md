...
각 토큰에 대해서 내적 계산을 통해 두 벡터 간의 유사성을 측정하고, 각 질문 토큰 $H_Q^i​$에 대해 가장 유사한 문장 토큰을 선택합니다. 이를 위해 각 질문 토큰 hQih_Q^ihQi​에 대해 문장 토큰 hDjh_D^jhDj​의 유사성 중 최대 값을 찾습니다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTcyODU4ODc0LDYyMjMzNjM5MCwtMTQ1Mj
