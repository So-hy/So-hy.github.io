...
생성기의 인코더는 검색기와 유사하게 작동한다. 먼저 질문 $Q$를 인코딩한다.  질문 $Q$는 BERT를 사용하여 인코딩되고, 다음과 같은 표현을 얻습니다:$$H_Q = [h^Q_1; h^Q_2; \cdots; h^Q_{|Q|+2}] = \text{BERT}([\text{CLS}], u^Q_1, u^Q_2, \cdots, u^Q_{|Q|}, [\text{SEP}])$$
-여기서 $u^Q_i$​는 질문의 토큰들입니다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTIzMDcyMjE3LDE4MzQ0NTIzMDQsNTcyOD
U4ODc0LDYyMjMzNjM5MCwtMTQ1Mjg1NjQ4OCw1MTI2OTEwMzQs
MTg4MzU1NjY3NSwtMTM4MzgwODk0NSw1ODE1NDI5LDUwNDgyNj
QwMiwtODk0MDA2OTgsLTg5MjU2NjI1NSwtMTIzNDkzNjY4Mywt
Nzc5NjU1MDgsODA4MzYyMzEwLDcwMDA5MTMyMSwtMTgyMzI1MD
QsLTE0MTkyODQ2ODYsLTE5NTA4NjE5NDEsMTM1ODkyNzM3Nl19
