...
위의 식과 같이 표현할 수 있으며, $y_0$ 는 훈련 시 무작위로 초기화된다. 디코더의 목표는 질문, 문장 또는 DSL에서 선택할 토큰을 결정하는 것이다.  위 식에서 $t$  단계에서의 변수들은 명시적으로 적지 않고  $t$ 로 간주한다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTEwNjU2NzMwOCwtMTk2MDc2MDQzMywtND
