...
$$
\text{sim}(H_Q, H_D) = \sum_{H_Q^i \in H_Q} \max_{j \in H_D} \frac{H_Q^i \cdot H_D^j}{\|H_Q^i\| \|H_D^j\|}
$$

질문 $Q$와 문장 $D'$ 의 각 토큰은 결과적으로 $[H_Q^1, H_Q^2, \ldots, H_Q^m]$와, $[H_D^1, H_D^2, \ldots, H_D^n]$ 임베딩 벡터를 가지게 된다.

각 토큰에 대해서 내적 계산을 통해 두 벡터 간의 유사성을 측정하고, 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTg4MjA5NTU5LDYyMjMzNjM5MCwtMTQ1Mj
