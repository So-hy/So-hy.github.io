...
각 검색된 문장 DRiD_{R_i}DRi​​는 질문 QQQ와 연결되어 인코딩되며, 이를 통해 질문과 완전히 상호작용할 수 있도록 합니다: 

HDR i = [h DR i 1 ; h DR i 2 ; · · · ; h DR i |DR i |+|Q|+3] = BERT([CLS], u DR i 1 , u DR i 2 , · · · , u DR i |DR i | , [SEP], u Q 1 , u Q 2 , · · · , u Q |Q| , [SEP]).

이 표현은 각 문장이 질문 토큰과 상호작용하여 더 나은 맥락적 이해를 가능하게 합니다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTMwNTM5ODcyNywxODM0NDUyMzA0LDU3Mj
