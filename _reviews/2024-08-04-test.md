...
1. **긴 문장 연결의 문제**: FinQANet의 생성기는 선택된 문장(검색된 문서에서 가져온 것)을 길게 연결하여 인코더에 입력한다. 이는 특정 숫자를 정확히 찾기 어려운 상황을 만듭니다. 예를 들어, “7%“라는 숫자를 생성해야 할 때, “7%“가 포함된 특정 문장에만 집중해야 하지만, FinQANet은 이를 잘 처리하지 못합니다.

2. **리트리버의 단순성**: FinQANet의 리트리버는 단순한 이진 분류기이기 때문에 질문과 문맥 간의 깊이 있는 상호작용을 충분히 활용하지 못합니다. 예를 들어, 질문에서 특정 연도(“2015”, “2016”)나 항목(“제3자 판매”)에 집중해야 하지만, 이는 어려운 일입니다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5OTM2NDIzODgsLTE4NDAwNjMzMjAsLT
E2OTIwMzMyNzMsLTE4ODEwMjk0MDEsMTgyNDY0LC0xOTAwMTI1
MDI1LC0xMzkxNjIyNDA2LDE5NzU5NDgyNjQsODg1MjAwMzg2LC
00ODcyNjczNyw2OTE1OTEzMjQsMjUzMTI2ODU5LC0zODQ1MTY4
MDcsLTE0ODMzNjM0MzgsLTE1Mzk0Nzk3NTIsLTc3MDQ0NDI3MC
wxNjE3NTk2OTM0XX0=
-->