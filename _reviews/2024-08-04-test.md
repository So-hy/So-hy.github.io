...
디코더는 현재 단계에서 어텐션 메커니즘을 사용하여 이전에 생성된 토큰 시퀀스  Y_t = [y_1; y_2; \cdots; y_{t-1}] 와 DSL 및 질문의 표현  H_{DSL} \| H 에 대해 집중할 부분을 결정한다.

생성된 $\hat{y}_t$는 어텐션 메커니즘의 쿼리로 사용된다. 이는 현재 단계에서 가장 중요하게 고려해야 할 정보를 찾기 위한 출발점이 된다.
어텐션 메커니즘은 $\hat{y}_t$와 이전에 생성된 모든 토큰 시퀀스 $Y_t$ 사이의 관련성을 계산한다:
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1NTAyOTU5ODIsLTk0NjE0MjMwNCwtMT
M2NzUxOTI0NiwtOTg0NTY1NjMxLDExOTQxMTI4OTksODg5NzIz
NTcsLTMyMDM4ODU3MiwtMTk2MDc2MDQzMywtNDgwMjU1MDU1LD
k3ODY1ODksMTgzNDQ1MjMwNCw1NzI4NTg4NzQsNjIyMzM2Mzkw
LC0xNDUyODU2NDg4LDUxMjY5MTAzNCwxODgzNTU2Njc1LC0xMz
gzODA4OTQ1LDU4MTU0MjksNTA0ODI2NDAyLC04OTQwMDY5OF19
