...
현재의 대화 시스템은 주로 텍스트 형식의 정보에서만 답을 찾는 데 집중하지만, 실제로 지식은 텍스트 외에도 여러 형태로 존재한다고 저자들은 설명한다. 예를 들어, 표는 여러 엔티티 간의 구조적인 관계를 표현하는 데 유용하며, 텍스트로는 효율적으로 전달할 수 없는 정보를 담고 있을 수 있습니다.


<!--stackedit_data:
eyJoaXN0b3J5IjpbMTkwNzY5Nzg5NSw2NjUyNTYzODksMjMwMz
