...
CTRLSciTab은 주로 **과학 논문**에서 **숫자 추론**과 관련된 테이블-설명 쌍을 통합한 데이터셋이다. 이를 위해 arXiv.org에서 테이블 메타데이터를 사용해 원본 과학 논문을 검색하고, 해당 테이블과 관련된 문장을 추출하여 **도메인 특화 지식** 기반을 구성했습니다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY0ODE3MjY2MiwtNDg4MzE3NDMxLDExMz
