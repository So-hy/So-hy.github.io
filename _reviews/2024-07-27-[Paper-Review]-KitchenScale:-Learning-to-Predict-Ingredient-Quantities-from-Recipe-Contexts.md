...
이 모델은 레시피 텍스트에서 요리 지식을 학습하는 전이 학습 방법을 사용하여 개발되었고, 레시피 데이터의 수치적 변동성을 효과적으로 처리하기 위해 이산 잠재 지수(**DExp**) 방법을 채택했다고 한.
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjA4Nzc0ODEwMiwtMTk0NTkyOTA3NCw3MT
U2MDkyOTQsODEyMzIwNDUyLC0xNTI1NDYyOTEwLDM1MTIyNTgy
MCwtMTc3MzgzNTc0N119
-->