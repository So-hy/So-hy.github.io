...
또한 인간의 검증이 추가로 진행되었다. 데이터의 품질과 정확성을 평가하기 위해, 전문 NLP 박사 학생이 생성된 가설에 라벨을 지정하고 문장의 문법 및 복잡성에 대해 1에서 5 사이의 점수를 부여한다. 문법 점수는 데이터의 의미 있고 어휘적으로 정확한 정도를, 복잡성 점수는 가설을 정확하게 라벨링하는 난이도를 나타낸다. 인간 검토자는 데이터의 99.4%가 정확하게 라벨링되었다고 평가했으며, 문장의 문법적 정확성에 대해 평균적으로 4.89의 높은 점수를 부여했다. 문장의 복잡성 점수는 평균 3.64이다.
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTYwMDAzNDIyNywtMTQwMTg5Njg1MiwtNj
