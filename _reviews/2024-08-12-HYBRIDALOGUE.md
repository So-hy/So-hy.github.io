...
반사실 테이블 생성 시, 중요한 논리적 제약을 유지한다. 예를 들어, 사람의 출생일과 사망일 사이에 논리적으로 타당한 순서를 유지해야 한다. 즉, 사망일은 출생일보다 늦은 날짜여야 한다.  이러한 제약을 따르지 않을 경우, 생성된 테이블이 논리적으로 부정확하거나 모순되는 정보를 담게 됩니다.
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTg3OTc5MzI3NywxMzMyNTYxMTA2LC0xND
