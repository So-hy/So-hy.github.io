...
•  RoBERTaBASE 모델이 대부분의 평가 분할에서 평균적으로 **약 80%의 정확도**를 달성했습니다. 이는 AUTO-TNLI 데이터셋이 INFOTABS 데이터셋과 비슷한 수준으로 도전적이라는 것을 보여줍니다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjAxNDU3OTcxMywtMTE1MjQ1NTc1MiwtOD
